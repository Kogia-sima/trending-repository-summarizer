...
def parse_markdown_to_notion_blocks(markdown):
    ...
    for line in lines:
        ...
        bookmark_match = re.match(bookmark_pattern, line)
        toc_match = re.match(toc_pattern, line, flags=re.IGNORECASE)
        ...
        elif line.strip().startswith("CODE_BLOCK_"):
            code_block_index = int(line.strip()[len("CODE_BLOCK_") :])
        ...
        # Image blocks
            ...
            caption = bookmark_match.group(1)
